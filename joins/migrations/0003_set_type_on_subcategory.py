...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for subcategory in orm.JoinSubcategory.objects.all():
    ...
    models = {
        ...
        u'joins.joindetail': {
            'Meta': {'object_name': 'JoinDetail', '_ormbases': [u'core.Detail']},
            u'detail_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.Detail']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'joins.joinsubcategory': {
            'Meta': {'object_name': 'JoinSubcategory', '_ormbases': [u'core.Subcategory']},
