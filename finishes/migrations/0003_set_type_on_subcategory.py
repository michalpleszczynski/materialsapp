...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for subcategory in orm.FinishSubcategory.objects.all():
    ...
    models = {
        ...
        u'finishes.finishdetail': {
            'Meta': {'object_name': 'FinishDetail', '_ormbases': [u'core.Detail']},
            u'detail_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.Detail']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'finishes.finishsubcategory': {
            'Meta': {'object_name': 'FinishSubcategory', '_ormbases': [u'core.Subcategory']},
