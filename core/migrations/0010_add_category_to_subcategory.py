...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_subcategory', 'category',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_subcategory', 'category_id')
    ...
    models = {
        u'core.category': {
            ...
            'subcategories': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'to_remove'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['core.Subcategory']"})
        },
        u'core.detail': {
