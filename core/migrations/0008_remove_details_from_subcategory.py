...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'core_subcategory_details'))


    def backwards(self, orm):
        # Adding M2M table for field details on 'Subcategory'
        m2m_table_name = db.shorten_name(u'core_subcategory_details')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subcategory', models.ForeignKey(orm[u'core.subcategory'], null=False)),
            ('detail', models.ForeignKey(orm[u'core.detail'], null=False))
        ))
