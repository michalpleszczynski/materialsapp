...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Detail.subcategory'
        db.alter_column(u'core_detail', 'subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Subcategory']))

    def backwards(self, orm):

        # Changing field 'Detail.subcategory'
        db.alter_column(u'core_detail', 'subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Subcategory'], null=True))
